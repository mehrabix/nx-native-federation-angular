    ...
    <header class="flex w-full items-center justify-between p-2 border border-black">
      <div class="flex-grow basis-[100%] items-center p-2">
        <a class="pr-4 text-neutral-500 hover:text-neutral-600 focus:text-neutral-600 [&.active]:text-black/80" routerLink="/home" routerLinkActive="active"
          >Home</a
        >
        <a class="pr-4 text-neutral-500 hover:text-neutral-600 focus:text-neutral-600 [&.active]:text-black/80" routerLink="/admin" routerLinkActive="active"
          >Admin</a
        >
        <a class="pr-4 text-neutral-500 hover:text-neutral-600 focus:text-neutral-600 [&.active]:text-black/80" routerLink="/login" routerLinkActive="active"
          >Login</a
        >
      </div>
